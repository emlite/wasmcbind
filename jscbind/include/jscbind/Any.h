...
/**
 * @brief A macro to create a `jb_Any` from another jscbind type.
 *
 * This is used for casting between different jscbind types (e.g., from
 * `jb_String` to `jb_Any`).
 *
 * @param x The jscbind value to convert.
 */
