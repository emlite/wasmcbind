...
/**
 * @file utils.h
 * @brief Utility macros for creating and managing jsbind types.
 *
 * This file provides macros to simplify the creation of new jsbind types that
 * wrap `emlite` values. These macros help ensure consistency and reduce
 * boilerplate code when defining new types.
 */

/**
 * @brief Declares a new jsbind type.
 *
 * This macro generates the necessary declarations for a new jsbind type,
 ...
 *
 * @param name The name of the new jsbind type (e.g., `jb_String`).
...
/**
 * @brief Defines the implementation for a new jsbind type.
 *
 * This macro generates the function implementations for the jsbind type
 * declared with `DECLARE_EMLITE_TYPE`. These functions handle the conversions
 * between the new type and other `emlite` types.
 *
 * @param name The name of the jsbind type.
