...
typedef struct wb_MLConv2dOptions wb_MLConv2dOptions;
typedef struct wb_MLConvTranspose2dOptions wb_MLConvTranspose2dOptions;
...
typedef struct wb_MLPool2dOptions wb_MLPool2dOptions;
typedef struct wb_MLReduceOptions wb_MLReduceOptions;
typedef struct wb_MLResample2dOptions wb_MLResample2dOptions;
