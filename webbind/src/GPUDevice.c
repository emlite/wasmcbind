...
#include <webbind/GPUBufferDescriptor.h>
#include <webbind/GPUTexture.h>
#include <webbind/GPUTextureDescriptor.h>
#include <webbind/GPUSampler.h>
#include <webbind/GPUSamplerDescriptor.h>
...
#include <webbind/GPUQuerySetDescriptor.h>
