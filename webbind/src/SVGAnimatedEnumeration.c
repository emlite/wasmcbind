...
unsigned short SVGAnimatedEnumeration_baseVal(const SVGAnimatedEnumeration *self) {
    return em_Val_as(unsigned short, em_Val_get(em_Val_as_val(self->inner), em_Val_from("baseVal")));
}
...
unsigned short SVGAnimatedEnumeration_animVal(const SVGAnimatedEnumeration *self) {
    return em_Val_as(unsigned short, em_Val_get(em_Val_as_val(self->inner), em_Val_from("animVal")));
}
