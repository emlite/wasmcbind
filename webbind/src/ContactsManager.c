...
jb_Sequence ContactInfo_address(const ContactInfo *self) {
    return em_Val_as(jb_Sequence, em_Val_get(em_Val_as_val(self->inner), em_Val_from("address")));
}
...
jb_Sequence ContactInfo_email(const ContactInfo *self) {
    return em_Val_as(jb_Sequence, em_Val_get(em_Val_as_val(self->inner), em_Val_from("email")));
}
...
jb_Sequence ContactInfo_icon(const ContactInfo *self) {
    return em_Val_as(jb_Sequence, em_Val_get(em_Val_as_val(self->inner), em_Val_from("icon")));
}
...
jb_Sequence ContactInfo_name(const ContactInfo *self) {
    return em_Val_as(jb_Sequence, em_Val_get(em_Val_as_val(self->inner), em_Val_from("name")));
}
...
jb_Sequence ContactInfo_tel(const ContactInfo *self) {
    return em_Val_as(jb_Sequence, em_Val_get(em_Val_as_val(self->inner), em_Val_from("tel")));
}
