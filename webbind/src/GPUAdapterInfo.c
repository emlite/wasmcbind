...
jb_DOMString GPUAdapterInfo_vendor(const GPUAdapterInfo *self) {
    return em_Val_as(jb_DOMString, em_Val_get(em_Val_as_val(self->inner), em_Val_from("vendor")));
}
...
jb_DOMString GPUAdapterInfo_device(const GPUAdapterInfo *self) {
    return em_Val_as(jb_DOMString, em_Val_get(em_Val_as_val(self->inner), em_Val_from("device")));
}
