...
MediaStreamTrackProcessor MediaStreamTrackProcessor_new(const jb_Any* init) : em_Val(em_Val_global("MediaStreamTrackProcessor").new_(em_Val_from(init))) {
        return MediaStreamTrackProcessor(em_Val_new(em_Val_global("MediaStreamTrackProcessor", em_Val_from(init)));
      }
