...
jb_DOMString KeyboardEvent_key(const KeyboardEvent *self) {
    return em_Val_as(jb_DOMString, em_Val_get(UIEvent_as_val(self->inner), em_Val_from("key")));
}


jb_DOMString KeyboardEvent_code(const KeyboardEvent *self) {
    return em_Val_as(jb_DOMString, em_Val_get(UIEvent_as_val(self->inner), em_Val_from("code")));
}
