...
bool FontFacePalette_usableWithLightBackground(const FontFacePalette *self) {
    return em_Val_as(bool, em_Val_get(em_Val_as_val(self->inner), em_Val_from("usableWithLightBackground")));
}


bool FontFacePalette_usableWithDarkBackground(const FontFacePalette *self) {
    return em_Val_as(bool, em_Val_get(em_Val_as_val(self->inner), em_Val_from("usableWithDarkBackground")));
}
