...
CaptureController CaptureController_new() : EventTarget(em_Val_global("CaptureController").new_()) {
        return CaptureController(em_Val_new(em_Val_global("CaptureController", ));
      }
...
jb_Any CaptureController_oncapturedmousechange(const CaptureController *self) {
    return em_Val_as(jb_Any, em_Val_get(EventTarget_as_val(self->inner), "oncapturedmousechange"));
}


void CaptureController_set_oncapturedmousechange(CaptureController* self, const jb_Any* value) {
    em_Val_set(EventTarget_as_val(self->inner), "oncapturedmousechange", value);
}
...
long CaptureController_zoomLevel(const CaptureController *self) {
    return em_Val_as(long, em_Val_get(EventTarget_as_val(self->inner), "zoomLevel"));
}
...
jb_Any CaptureController_onzoomlevelchange(const CaptureController *self) {
    return em_Val_as(jb_Any, em_Val_get(EventTarget_as_val(self->inner), "onzoomlevelchange"));
}


void CaptureController_set_onzoomlevelchange(CaptureController* self, const jb_Any* value) {
    em_Val_set(EventTarget_as_val(self->inner), "onzoomlevelchange", value);
}
