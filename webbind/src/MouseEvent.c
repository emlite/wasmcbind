...
MouseEvent MouseEvent_new0(jb_DOMString * type) {
...
jb_Undefined MouseEvent_initMouseEvent1(MouseEvent* self , jb_DOMString * typeArg, bool bubblesArg) {
...
jb_Undefined MouseEvent_initMouseEvent2(MouseEvent* self , jb_DOMString * typeArg, bool bubblesArg, bool cancelableArg) {
...
jb_Undefined MouseEvent_initMouseEvent3(MouseEvent* self , jb_DOMString * typeArg, bool bubblesArg, bool cancelableArg, Window * viewArg) {
...
jb_Undefined MouseEvent_initMouseEvent4(MouseEvent* self , jb_DOMString * typeArg, bool bubblesArg, bool cancelableArg, Window * viewArg, long detailArg) {
...
jb_Undefined MouseEvent_initMouseEvent5(MouseEvent* self , jb_DOMString * typeArg, bool bubblesArg, bool cancelableArg, Window * viewArg, long detailArg, long screenXArg) {
...
jb_Undefined MouseEvent_initMouseEvent6(MouseEvent* self , jb_DOMString * typeArg, bool bubblesArg, bool cancelableArg, Window * viewArg, long detailArg, long screenXArg, long screenYArg) {
...
jb_Undefined MouseEvent_initMouseEvent7(MouseEvent* self , jb_DOMString * typeArg, bool bubblesArg, bool cancelableArg, Window * viewArg, long detailArg, long screenXArg, long screenYArg, long clientXArg) {
...
jb_Undefined MouseEvent_initMouseEvent8(MouseEvent* self , jb_DOMString * typeArg, bool bubblesArg, bool cancelableArg, Window * viewArg, long detailArg, long screenXArg, long screenYArg, long clientXArg, long clientYArg) {
...
jb_Undefined MouseEvent_initMouseEvent9(MouseEvent* self , jb_DOMString * typeArg, bool bubblesArg, bool cancelableArg, Window * viewArg, long detailArg, long screenXArg, long screenYArg, long clientXArg, long clientYArg, bool ctrlKeyArg) {
...
jb_Undefined MouseEvent_initMouseEvent10(MouseEvent* self , jb_DOMString * typeArg, bool bubblesArg, bool cancelableArg, Window * viewArg, long detailArg, long screenXArg, long screenYArg, long clientXArg, long clientYArg, bool ctrlKeyArg, bool altKeyArg) {
...
jb_Undefined MouseEvent_initMouseEvent11(MouseEvent* self , jb_DOMString * typeArg, bool bubblesArg, bool cancelableArg, Window * viewArg, long detailArg, long screenXArg, long screenYArg, long clientXArg, long clientYArg, bool ctrlKeyArg, bool altKeyArg, bool shiftKeyArg) {
...
jb_Undefined MouseEvent_initMouseEvent12(MouseEvent* self , jb_DOMString * typeArg, bool bubblesArg, bool cancelableArg, Window * viewArg, long detailArg, long screenXArg, long screenYArg, long clientXArg, long clientYArg, bool ctrlKeyArg, bool altKeyArg, bool shiftKeyArg, bool metaKeyArg) {
...
jb_Undefined MouseEvent_initMouseEvent13(MouseEvent* self , jb_DOMString * typeArg, bool bubblesArg, bool cancelableArg, Window * viewArg, long detailArg, long screenXArg, long screenYArg, long clientXArg, long clientYArg, bool ctrlKeyArg, bool altKeyArg, bool shiftKeyArg, bool metaKeyArg, short buttonArg) {
...
jb_Undefined MouseEvent_initMouseEvent14(MouseEvent* self , jb_DOMString * typeArg, bool bubblesArg, bool cancelableArg, Window * viewArg, long detailArg, long screenXArg, long screenYArg, long clientXArg, long clientYArg, bool ctrlKeyArg, bool altKeyArg, bool shiftKeyArg, bool metaKeyArg, short buttonArg, EventTarget * relatedTargetArg) {
