...
bool FileSystemEntry_isFile(const FileSystemEntry *self) {
    return em_Val_as(bool, em_Val_get(em_Val_as_val(self->inner), "isFile"));
}


bool FileSystemEntry_isDirectory(const FileSystemEntry *self) {
    return em_Val_as(bool, em_Val_get(em_Val_as_val(self->inner), "isDirectory"));
}
...
jb_USVString FileSystemEntry_fullPath(const FileSystemEntry *self) {
    return em_Val_as(jb_USVString, em_Val_get(em_Val_as_val(self->inner), "fullPath"));
}


FileSystem FileSystemEntry_filesystem(const FileSystemEntry *self) {
    return em_Val_as(FileSystem, em_Val_get(em_Val_as_val(self->inner), "filesystem"));
}
