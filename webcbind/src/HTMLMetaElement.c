#include <webcbind/HTMLMetaElement.h>
...
jb_String HTMLMetaElement_httpEquiv(const HTMLMetaElement *self) {
    return em_Val_as(jb_String, em_Val_get(HTMLElement_as_val(self->inner), em_Val_from("httpEquiv")));
}
...
jb_String HTMLMetaElement_content(const HTMLMetaElement *self) {
    return em_Val_as(jb_String, em_Val_get(HTMLElement_as_val(self->inner), em_Val_from("content")));
}
...
jb_String HTMLMetaElement_scheme(const HTMLMetaElement *self) {
    return em_Val_as(jb_String, em_Val_get(HTMLElement_as_val(self->inner), em_Val_from("scheme")));
}
