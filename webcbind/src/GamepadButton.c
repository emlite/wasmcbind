...
bool GamepadButton_pressed(const GamepadButton *self) {
    return em_Val_as(bool, em_Val_get(em_Val_as_val(self->inner), em_Val_from("pressed")));
}


bool GamepadButton_touched(const GamepadButton *self) {
    return em_Val_as(bool, em_Val_get(em_Val_as_val(self->inner), em_Val_from("touched")));
}
