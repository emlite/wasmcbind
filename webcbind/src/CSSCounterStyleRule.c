#include <webcbind/CSSCounterStyleRule.h>
...
jb_String CSSCounterStyleRule_system(const CSSCounterStyleRule *self) {
    return em_Val_as(jb_String, em_Val_get(CSSRule_as_val(self->inner), em_Val_from("system")));
}
...
jb_String CSSCounterStyleRule_symbols(const CSSCounterStyleRule *self) {
    return em_Val_as(jb_String, em_Val_get(CSSRule_as_val(self->inner), em_Val_from("symbols")));
}
...
jb_String CSSCounterStyleRule_additiveSymbols(const CSSCounterStyleRule *self) {
    return em_Val_as(jb_String, em_Val_get(CSSRule_as_val(self->inner), em_Val_from("additiveSymbols")));
}
...
jb_String CSSCounterStyleRule_negative(const CSSCounterStyleRule *self) {
    return em_Val_as(jb_String, em_Val_get(CSSRule_as_val(self->inner), em_Val_from("negative")));
}
...
jb_String CSSCounterStyleRule_suffix(const CSSCounterStyleRule *self) {
    return em_Val_as(jb_String, em_Val_get(CSSRule_as_val(self->inner), em_Val_from("suffix")));
}
...
jb_String CSSCounterStyleRule_range(const CSSCounterStyleRule *self) {
    return em_Val_as(jb_String, em_Val_get(CSSRule_as_val(self->inner), em_Val_from("range")));
}
...
jb_String CSSCounterStyleRule_pad(const CSSCounterStyleRule *self) {
    return em_Val_as(jb_String, em_Val_get(CSSRule_as_val(self->inner), em_Val_from("pad")));
}
...
jb_String CSSCounterStyleRule_speakAs(const CSSCounterStyleRule *self) {
    return em_Val_as(jb_String, em_Val_get(CSSRule_as_val(self->inner), em_Val_from("speakAs")));
}
...
jb_String CSSCounterStyleRule_fallback(const CSSCounterStyleRule *self) {
    return em_Val_as(jb_String, em_Val_get(CSSRule_as_val(self->inner), em_Val_from("fallback")));
}
